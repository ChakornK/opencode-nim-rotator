...
// biome-ignore lint/suspicious/noExplicitAny: event system is polymorphic, handlers receive varying argument signatures
...
// biome-ignore lint/suspicious/noExplicitAny: findDescendantById returns Renderable, callers expect VNode-like interface
